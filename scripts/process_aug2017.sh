...
RAW="/afs/cern.ch/work/b/bojan/Judith/data/aug2017/raw/acq$1"
CONV="/afs/cern.ch/work/b/bojan/Judith/data/aug2017/conv/ref$1" 
ANA="/afs/cern.ch/work/b/bojan/Judith/data/aug2017/ana/ref$1" 

./Judith -c convert -i $RAW.bin -o $CONV.root -n 30000
### Alignment ###
